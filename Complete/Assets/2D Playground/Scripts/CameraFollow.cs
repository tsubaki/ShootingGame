...
namespace UnityStandardAssets._2D
{
    public class CameraFollow : MonoBehaviour
    {
        ...
        private void TrackPlayer()
        {
			...
			float x = camera.aspect * camera.orthographicSize;
            ...
            targetX = Mathf.Clamp(targetX, minXAndY.x + x, maxXAndY.x - x);
            targetY = Mathf.Clamp(targetY, minXAndY.y + y, maxXAndY.y - y);
